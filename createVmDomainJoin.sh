...
echo "Creating VM"
az vm create --resource-group $rg --name $vmname --nics "$vmname-nic" --location $location --license-type None --image $image --size $vmsize --admin-username $localadminuser --admin-password $localadminpw
